...
public class LongTwoQualified_SimpleDecoratorResolutionStrategyTest {
	...
	public void testChaining_ContainsMyDecorator() {
		Assert.isTrue(decoratorResolutionStrategy.getRegisteredDecorators(
				beanFactory).containsKey("longTwoQualified_MyDecorator"));
	}

	@Test
	public void testChaining_ContainsMyDecorator2() {
		Assert.isTrue(decoratorResolutionStrategy.getRegisteredDecorators(
				beanFactory).containsKey("longTwoQualified_MyDecorator2"));
	}

	@Test
	public void testChaining_ContainsAnotherDecorator() {
		Assert.isTrue(decoratorResolutionStrategy.getRegisteredDecorators(
				beanFactory).containsKey("longTwoQualified_AnotherDecorator"));
	}

	@Test
	public void testChaining_ContainsAnotherDecorator2() {
		Assert.isTrue(decoratorResolutionStrategy.getRegisteredDecorators(
				beanFactory).containsKey("longTwoQualified_AnotherDecorator2"));
	}
}
