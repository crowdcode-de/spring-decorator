...
public class Meta_SimpleDelegateAnnotationTest {
	...
	public void testDelegateClassInjection() {
		Assert.isTrue(Meta_MyDelegate.class.isAssignableFrom(delegate
				.getClass()));
	}
	...
	public void testServiceInterfaceInjection() {
		...
		Assert.isTrue(Meta_MyDelegate.class.isAssignableFrom(AopUtils
				.getTargetClass(decoratedInterface)));
	}

	@Test
	public void testFirstDecorator() {
		DelegateProxyInspector pi = (DelegateProxyInspector) decoratedInterface;
		Assert.isTrue(pi.getInterceptorTarget().getClass()
				.isAssignableFrom(Meta_MyDecorator.class));
	}

	@Test
	public void testDelegate() {
		Assert.isTrue(Meta_MyDelegate.class.isAssignableFrom(decoratedInterface
