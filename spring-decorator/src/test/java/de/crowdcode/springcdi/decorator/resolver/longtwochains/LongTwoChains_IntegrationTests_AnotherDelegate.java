...
public class LongTwoChains_IntegrationTests_AnotherDelegate {
	...
	public void testInjectedObject() {
		...
		Assert.assertTrue(decoratedInterface.getClass().getSimpleName()
				.startsWith("LongTwoChains_AnotherDecorator"));
	}
	...
	public void testSecondDecorator() {
		...
		Assert.assertTrue(decoratedInterface.getDelegateObject().getClass()
				.getSimpleName().startsWith("LongTwoChains_AnotherDecorator"));
	}

	@Test
	public void testThirdDecorator() {
		Assert.assertTrue(AopUtils.getTargetClass(
				decoratedInterface.getDelegateObject().getDelegateObject())
				.getAnnotation(Decorator.class) != null);
		Assert.assertTrue(decoratedInterface.getDelegateObject()
				.getDelegateObject().getClass().getSimpleName()
				.startsWith("LongTwoChains_AnotherDecorator"));
	}

	@Test
	public void testDelegateTargetObject() {
		Assert.assertTrue(LongTwoChains_AnotherDelegate.class
