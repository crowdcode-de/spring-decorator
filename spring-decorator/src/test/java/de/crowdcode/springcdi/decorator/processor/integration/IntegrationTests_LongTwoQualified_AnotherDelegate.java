...
import de.crowdcode.springcdi.decorator.resolver.longtwoqualified.LongTwoQualified_AnotherDelegate;
...
@DirtiesContext
public class IntegrationTests_LongTwoQualified_AnotherDelegate extends
		LongTwoQualified_IntegrationTests_AnotherDelegate {

	@Test
	public void testInjectedObject() {
		Assert.assertTrue(LongTwoQualified_AnotherDelegate.class
